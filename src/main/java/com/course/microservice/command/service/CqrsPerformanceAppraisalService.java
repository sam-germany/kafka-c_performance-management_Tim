...
public class CqrsPerformanceAppraisalService {
	...
	public void approvePerformanceAppraisal(String appraisalId) throws NoSuchElementException, JsonProcessingException {
		...
		if (transactionAction.isAppraisalInFinalState(performanceAppraisal)) { return; }  // their he created  a method in the PerformanceAppraisal class
	...
	@Transactional
	public PerformanceAppraisal createPerformanceAppraisal(String employeeId, String grade, int score) throws JsonProcessingException {
