...
public class CqrsPerformanceAppraisalApi {
	...
	public ResponseEntity<PerformanceAppraisalApprovalResponse> approvePerformanceAppraisal(
		                 	   @PathVariable(name = "appraisal_id", required = true) String appraisalId)  throws NoSuchElementException, JsonProcessingException {
	...
	public ResponseEntity<PlainMessage> createPerformanceAppraisal(@RequestBody(required = true) PerformanceAppraisalRequest requestBody)
			throws JsonProcessingException, InterruptedException {

		var savedAppraisal = service.createPerformanceAppraisal( requestBody.getEmployeeId(),
